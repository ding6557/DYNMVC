...
namespace Maticsoft.Common
{
    ...
    public class DateTimeHelper
    {
        ...
        /// 计算两个日期相差的月份
        /// </summary>
        /// <param name="begin">开始时间，小时间</param>
        /// <param name="end">结束时间，大时间</param>
        /// <returns>两个时间相差的月数</returns>
        public static int GetDiffMonths(DateTime begin, DateTime end)
        {
            int span = 0;
            int ys = end.Year - begin.Year;
            int ms = end.Month - begin.Month;
            span = ys * 12 + ms;
            return span;
        }
        #endregion
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public static int DataTo8Number(DateTime dt)
        {
            int I = dt.Year * 10000 + dt.Month * 100 + dt.Day;
            return I;
        }
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public static int TimeTo8Number(DateTime dt)
        {
            int I = dt.Hour * 10000 + dt.Minute * 100 + dt.Second;
            return I;
        }
