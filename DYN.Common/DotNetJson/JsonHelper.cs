    ...
    public class JsonHelper
    {
       ...
       // protected static LogHelper Logger = new LogHelper("转换Json格式帮助类");
        ...
        public static string GetDataFromJSON(string json)
        {
            ...
            int begin = json.IndexOf("\"content\":") + 10;
        ...
        public static DataTable Getdt(string url)
        {
            string newslist = HttpHelper.Get(url);
            string jsonlist = JsonHelper.GetDataFromJSON(newslist);
            DataTable dt = JsonHelper.JsonToDataTable(jsonlist);
            return dt;
        }
    }
}
